...
// ── Question bank (15 câu TTHCM giai đoạn 1911–1930) ────────────────────────
const ALL_QUESTIONS: Question[] = [
  {
    question: 'Nguyễn Tất Thành rời cảng Nhà Rồng ra đi tìm đường cứu nước vào ngày nào?',
    options: ['5/6/1911', '3/2/1911', '19/5/1911', '1/9/1858'],
    correctIndex: 0,
    explanation: 'Ngày 5/6/1911, Nguyễn Tất Thành rời cảng Nhà Rồng trên tàu Amiral Latouche-Tréville, bắt đầu hành trình 30 năm bôn ba tìm đường cứu nước.',
  },
  {
    question: 'Năm 1919, Nguyễn Ái Quốc gửi bản "Yêu sách của nhân dân An Nam" đến Hội nghị nào?',
    options: ['Hội nghị Berlin', 'Hội nghị Hoà bình Versailles', 'Hội nghị Genève', 'Hội nghị Potsdam'],
    correctIndex: 1,
    explanation: 'Năm 1919, Nguyễn Ái Quốc gửi bản Yêu sách 8 điểm đến Hội nghị Hoà bình Versailles, đòi quyền tự do và bình đẳng cho nhân dân An Nam.',
  },
  {
    question: 'Sự kiện nào năm 1920 đánh dấu bước ngoặt tư tưởng quyết định của Nguyễn Ái Quốc?',
    options: [
      'Gia nhập Quốc tế Cộng sản đệ nhất',
      'Đọc "Sơ thảo luận cương về vấn đề dân tộc và thuộc địa" của Lênin',
      'Gặp gỡ Tôn Dật Tiên tại Trung Quốc',
      'Xuất bản tác phẩm Đường Kách Mệnh',
    ],
    correctIndex: 1,
    explanation: 'Năm 1920, khi đọc Luận cương của Lênin, Nguyễn Ái Quốc tìm thấy con đường cứu nước đúng đắn — con đường cách mạng vô sản theo chủ nghĩa Mác-Lênin.',
  },
  {
    question: 'Tại Đại hội Tours (12/1920), Nguyễn Ái Quốc bỏ phiếu gia nhập tổ chức nào?',
    options: ['Đảng Xã hội Pháp', 'Quốc tế Cộng sản (Đệ tam Quốc tế)', 'Hội Liên hiệp các dân tộc thuộc địa', 'Đảng Lao động Anh'],
    correctIndex: 1,
    explanation: 'Tại Đại hội Tours tháng 12/1920, Nguyễn Ái Quốc bỏ phiếu tán thành gia nhập Quốc tế Cộng sản và trở thành một trong những người sáng lập Đảng Cộng sản Pháp.',
  },
  {
    question: 'Tờ báo "Le Paria" (Người cùng khổ) do Nguyễn Ái Quốc sáng lập năm nào?',
    options: ['1919', '1921', '1922', '1925'],
    correctIndex: 2,
    explanation: 'Năm 1922, Nguyễn Ái Quốc sáng lập tờ báo Le Paria (Người cùng khổ) — cơ quan ngôn luận của Hội Liên hiệp các dân tộc thuộc địa, tố cáo chủ nghĩa thực dân.',
  },
  {
    question: 'Năm 1921, Nguyễn Ái Quốc sáng lập tổ chức nào tại Pháp?',
    options: [
    ...
    correctIndex: 2,
    explanation: 'Năm 1921, Nguyễn Ái Quốc cùng các chiến sĩ cách mạng quốc tế sáng lập Hội Liên hiệp các dân tộc thuộc địa tại Pháp, tập hợp lực lượng đấu tranh chống thực dân.',
  },
  {
    question: 'Nguyễn Ái Quốc đến Liên Xô (Moscow) lần đầu vào năm nào?',
    options: ['1921', '1923', '1925', '1927'],
    correctIndex: 1,
    explanation: 'Năm 1923, Nguyễn Ái Quốc đến Moskva, học tập tại trường Đại học Phương Đông và hoạt động trong Quốc tế Cộng sản, tiếp tục hoàn thiện tư tưởng cách mạng.',
  },
  {
    question: 'Năm 1925 tại Quảng Châu (Trung Quốc), Nguyễn Ái Quốc thành lập tổ chức nào?',
    options: [
    ...
    correctIndex: 1,
    explanation: 'Tháng 6/1925, Nguyễn Ái Quốc thành lập Hội Việt Nam Cách mạng Thanh niên tại Quảng Châu — tổ chức tiền thân trực tiếp của Đảng Cộng sản Việt Nam.',
  },
  {
    question: 'Tác phẩm "Đường Kách Mệnh" (1927) của Nguyễn Ái Quốc trình bày chủ yếu điều gì?',
    options: [
      'Lịch sử chống ngoại xâm của dân tộc Việt Nam',
      'Lý luận cách mạng giải phóng dân tộc và vai trò lãnh đạo của Đảng',
      'Phương pháp tác chiến quân sự du kích',
      'Chính sách kinh tế xã hội chủ nghĩa',
    ],
    correctIndex: 1,
    explanation: '"Đường Kách Mệnh" (1927) trình bày con đường cứu nước, vai trò lãnh đạo của Đảng, lực lượng cách mạng và tính chất của cách mạng Việt Nam theo chủ nghĩa Mác-Lênin.',
  },
  {
    question: 'Theo Nguyễn Ái Quốc, lực lượng nào giữ vai trò lãnh đạo cách mạng?',
    options: ['Giai cấp tư sản dân tộc', 'Giai cấp công nhân thông qua Đảng Cộng sản', 'Tầng lớp trí thức tiến bộ', 'Nông dân nghèo'],
    correctIndex: 1,
    explanation: 'Nguyễn Ái Quốc khẳng định giai cấp công nhân — thông qua Đảng Cộng sản tiên phong — giữ vai trò lãnh đạo cách mạng, trong liên minh chặt chẽ với giai cấp nông dân.',
  },
  {
    question: 'Đảng Cộng sản Việt Nam được thành lập vào ngày, tháng, năm nào?',
    options: ['19/5/1925', '3/2/1930', '19/8/1945', '2/9/1945'],
    correctIndex: 1,
    explanation: 'Ngày 3/2/1930, tại Cửu Long (Hồng Kông), Nguyễn Ái Quốc chủ trì Hội nghị hợp nhất ba tổ chức cộng sản, thành lập Đảng Cộng sản Việt Nam.',
  },
  {
    question: 'Nguyễn Ái Quốc đã hợp nhất mấy tổ chức cộng sản để thành lập Đảng năm 1930?',
    options: ['Hai tổ chức', 'Ba tổ chức', 'Bốn tổ chức', 'Chỉ một tổ chức'],
    correctIndex: 1,
    explanation: 'Nguyễn Ái Quốc hợp nhất ba tổ chức: Đông Dương Cộng sản Đảng, An Nam Cộng sản Đảng và Đông Dương Cộng sản Liên đoàn thành Đảng Cộng sản Việt Nam.',
  },
  {
    question: 'Con đường cứu nước mà Nguyễn Ái Quốc lựa chọn sau năm 1920 là gì?',
    options: [
      'Dựa vào ngoại viện từ Nhật Bản',
      'Cải cách theo mô hình dân chủ tư sản phương Tây',
      'Cách mạng vô sản gắn độc lập dân tộc với chủ nghĩa xã hội',
      'Bạo động ám sát theo kiểu Phan Bội Châu',
    ],
    correctIndex: 2,
    explanation: 'Sau khi đọc Luận cương Lênin (1920), Nguyễn Ái Quốc xác định con đường cứu nước là cách mạng vô sản: kết hợp giải phóng dân tộc với giải phóng giai cấp, tiến lên chủ nghĩa xã hội.',
  },
  {
    question: 'Trong giai đoạn 1911–1930, Nguyễn Ái Quốc đã bôn ba qua bao nhiêu quốc gia và vùng lãnh thổ?',
    options: ['Chỉ Pháp và Liên Xô', 'Hơn 30 quốc gia và vùng lãnh thổ', 'Chỉ các nước châu Á', '5 quốc gia'],
    correctIndex: 1,
    explanation: 'Trong hành trình bôn ba từ 1911–1930, Nguyễn Ái Quốc đã đặt chân đến hơn 30 quốc gia và vùng lãnh thổ trên khắp các châu lục để tìm đường cứu nước.',
  },
  {
    question: 'Điểm khác biệt cơ bản trong con đường cứu nước của Nguyễn Ái Quốc so với Phan Bội Châu, Phan Châu Trinh là gì?',
    options: [
      'Chọn bạo động vũ trang ngay từ đầu',
      'Dựa vào tầng lớp phong kiến trong nước',
      'Gắn giải phóng dân tộc với giải phóng giai cấp theo chủ nghĩa Mác-Lênin',
      'Cải cách văn hóa, giáo dục trước rồi mới đấu tranh',
    ],
    correctIndex: 2,
    explanation: 'Khác với Phan Bội Châu (dựa vào Nhật) hay Phan Châu Trinh (cải cách dân chủ tư sản), Nguyễn Ái Quốc chọn con đường gắn giải phóng dân tộc với giải phóng giai cấp theo học thuyết Mác-Lênin — triệt để và đúng đắn nhất.',
  },
];
