  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-4 py-12">
      <div className="museum-card w-full max-w-md p-8">
        <h1 className="font-display text-3xl font-bold text-heritage-red dark:text-heritage-gold text-center">Register</h1>
        ...
        <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
          ...
          <Link href="/login" className="text-heritage-red dark:text-heritage-gold font-medium hover:underline">Login</Link>
        </p>
      </div>
    </div>
  );
